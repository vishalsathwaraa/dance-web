    ...
    >
      <div className="container mx-auto flex px-5 pt-24 pb-10 items-center justify-center flex-col">
        <img
          ...
          className="sm:w-48 lg:w-2/6 md:w-3/6 w-72 mb-12 object-cover object-center "
          alt="hero"
          ...
          <div className="flex justify-center">
            <a href="music.php">
              <button
                data-aos="fade-left"
                data-aos-duration="1500"
                className="inline-flex text-black bg-gray-300  border-0 mr-10 py-2 px-6 focus:outline-none rounded text hvr-shutter-in-horizontal"
              >
                My Music
              </button>
            </a>
            <a href="dance.php">
              ...
              <button
                data-aos="fade-up"
                data-aos-duration="1500"
                className="inline-flex text-black bg-gray-300  border-0 py-2 px-6  rounded text"
              >
                Watch Videos
              </button>
            </a>
